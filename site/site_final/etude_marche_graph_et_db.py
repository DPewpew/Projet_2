...
# Routing
# -----------------------------
if section == "Graph 1 — Âges (2022)":
    _df_age_clean = graph_1(df_age)

elif section == "Graph 2 — Vieillissement (2011–2022)":
    _df_age_clean = graph_1(df_age)  # pour récupérer df_age_clean
    graph_2(_df_age_clean)

elif section == "Graph 3 — Ménages (2022)":
    graph_3(df_menages)

elif section == "Graph 4 — Pauvreté (2021)":
    graph_4(df_pauvrete)

elif section == "Graph 5 — Salaires (2023)":
    graph_5(df_sal_age)

elif section == "Graph 6 — Écrans (1966–2024)":
    graph_6(df_cnc_ecrans)

elif section == "Graph 7+8 — Entrées + Indice":
    graph_7_8(df_cnc_entrees, df_cnc_indice)

elif section == "Graph 9 — Personas (tableau)":
    graph_9()

elif section == "Tout afficher":
    _df_age_clean = graph_1(df_age)
    graph_2(_df_age_clean)
    graph_3(df_menages)
    graph_4(df_pauvrete)
